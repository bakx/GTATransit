...
namespace Models
{
    public class FareAttributes
    {
        ...
        /// <summary>
        /// Indicates when the fare must be paid. Valid options are:0 - Fare is paid on board.1 - Fare must be paid before
        /// boarding.
        /// </summary>
        ...
        /// <summary>
        /// Indicates the number of transfers permitted on this fare. The fact that this field can be left empty is an exception to
        /// the requirement that a Required field must not be empty. Valid options are:0 - No transfers permitted on this fare.1 -
        /// Riders may transfer once.2 - Riders may transfer twice.empty - Unlimited transfers are permitted.
        /// </summary>
        [DataMember(Name = "transfers", IsRequired = true)]
        public string Transfers { get; set; }

        /// <summary>
        /// Identifies the relevant agency for a fare. This field is required for datasets with multiple agencies defined in
        /// agency.txt, otherwise it is optional.
        /// </summary>
