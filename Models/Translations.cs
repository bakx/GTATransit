...
namespace Models
{
 public abstract class Translations
 {
        ...
        /// <summary>
        /// Defines the dataset table that contains the field to be translated. The following values are allowed:agencystopsroutestripsstop_timesfeed_infoNote: Don't include the .txt file extension after the table's name.
        /// </summary>
        [DataMember(Name = "table_name", IsRequired = true)]
        public string TableName { get; set; }
        /// <summary>
        /// Provides the name of the field to be translated. Fields with the type "Text" can be translated, while fields with the types "URL," "Email," and "Phone number" can be included here to provide those resources in the correct language.Note: Fields with other types are ignored and will not be translated.
        /// </summary>
        [DataMember(Name = "field_name", IsRequired = true)]
        public string FieldName { get; set; }
        /// <summary>
        /// Provides the language of translation.If this language is the same as the one from feed_lang in feed_info.txt, the original value of the field is the default value used in languages without specific translations.For example, in Switzerland, a city in a bilingual canton is officially called "Biel/Bienne," but it would simply be called "Bienne" in French and "Biel" in German.
        /// </summary>
        ...
        /// <summary>
        /// Defines the record that corresponds to the field to be translated. The value in record_id needs to be a main ID from a dataset table, as defined in the following table:table_nameagencystopsroutestripsstop_timespathwayslevelsThe following conditions determine how this field can be used:Forbidden if table_name equals feed_info.Forbidden if field_value is defined.Required if field_value is empty.
        /// </summary>
        [DataMember(Name = "record_id", IsRequired = false)]
        public string RecordId { get; set; }
        /// <summary>
        /// Helps to translate the record that contains the field when the table referenced in record_id doesn’t have a unique ID. The value in record_sub_id is the secondary ID of a dataset table, as defined in the following table:table_nameagencystopsroutestripsstop_timespathwayslevelsThe following conditions determine how this field can be used:Forbidden if table_name equals feed_info.Forbidden if field_value is defined.Required if table_name equals stop_times and record_id is defined.
        /// </summary>
