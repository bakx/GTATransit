...
namespace Models
{
    public class Attributions
    {
        ...
        /// <summary>
        /// The role of the organization is producer. Allowed values include the following:• 0 or empty: Organization doesn’t have
        /// this role.• 1: Organization does have this role.At least one of the fields, either is_producer, is_operator, or
        /// is_authority, must be set at 1.
        /// </summary>
